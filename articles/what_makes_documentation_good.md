...
연결된 목록. 목차에는 종종 간과되는 두 번째 이점도 있습니다. 즉, 독자에게 문서에 대한 단서를 제공하여 읽을 가치가 있는지 이해하는 데 도움이 됩니다. 단락을 짧게 유지하세요. 단락이 짧을수록 훑어보기가 더 쉽습니다. 중요한 요점이 있는 경우 한 문장으로 된 단락에 넣어서 놓칠 확률을 줄이는 것이 좋습니다. 긴 문단은 정보를 묻어둘 수 있습니다. 독립형 미리보기를 제공하는 짧은 주제 문장으로 단락과 섹션을 시작하세요. 사람들은 훑어볼 때 섹션의 첫 단어, 첫 줄, 첫 문장을 불균형적으로 봅니다. 이전 텍스트에 의존하지 않는 방식으로 이 문장을 작성하세요. 예를 들어, “이제 더 빠른 방법에 대해 이야기해 보겠습니다.”라는 첫 번째 문장을 생각해 보세요. 이 문장은 누군가에게는 의미가 없겠지만
